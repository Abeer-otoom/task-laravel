...
-- Dumping structure for table task.oauth_access_tokens
...
-- Dumping structure for table task.oauth_auth_codes
...
-- Dumping structure for table task.oauth_clients
...
-- Dumping structure for table task.oauth_personal_access_clients
...
-- Dumping structure for table task.oauth_refresh_tokens
